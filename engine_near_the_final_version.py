...
class mechanizm():
    ...
    ##K: Basic variables
    def __init__(self):
        self.nagrody = ["0$","500$","1000$","2000$","5000$","10 000$","20 000$","40 000$","75 000$","125 000$","250 000$","500 000$","1 000 000$"]
        self.stan_konta = "500$"
        self.odp = ""
